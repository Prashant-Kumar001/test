                    ...
                    {orders.length === 0 ? (
                        ...
                        <div className="overflow-auto rounded-xl shadow-sm border border-gray-200">
                            <table className="min-w-full divide-y divide-gray-200 text-sm text-left">
                                <thead className="bg-gray-100 font-lato  text-gray-700 font-semibold">
                                    <tr>
                                ...
                                <tbody className="bg-white font-ubuntu divide-y divide-gray-100">
                                    {orders.map((order) => {
                                        ...
                                        return (
                                            <tr key={order._id} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-4 text-gray-700">₹{order.subTotal}</td>
                                                <td className="px-4 py-4 text-gray-700">₹{order.discount}</td>
                                                ...
                                                <td className="px-4 py-4">
                                                    <span
                                                        className={`px-3 py-1 text-xs font-medium rounded-full ${order.status === "PENDING"
                                                ...
                                                <td className="px-4 py-4 text-right">
                                                    <button
                                                        ...
                                                        className="text-indigo-600 cursor-pointer hover:text-indigo-800 transition"
                                                    >
